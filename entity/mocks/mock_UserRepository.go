...
// ReadUser provides a mock function with given fields: ctx, user
func (_m *UserRepository) ReadUser(ctx context.Context, user *entity.User) (*entity.User, error) {
	ret := _m.Called(ctx, user)
...
//   - ctx context.Context
//   - user *entity.User
func (_e *UserRepository_Expecter) ReadUser(ctx interface{}, user interface{}) *UserRepository_ReadUser_Call {
	return &UserRepository_ReadUser_Call{Call: _e.mock.On("ReadUser", ctx, user)}
}

func (_c *UserRepository_ReadUser_Call) Run(run func(ctx context.Context, user *entity.User)) *UserRepository_ReadUser_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(*entity.User))
	})
	return _c
...
func (_c *UserRepository_ReadUser_Call) RunAndReturn(run func(context.Context, *entity.User) (*entity.User, error)) *UserRepository_ReadUser_Call {
	_c.Call.Return(run)
	return _c
}
