...
func (_m *MissionRepository) ListMultiChallenges(ctx context.Context, params entity.ListMultiChallengeParams) ([]entity.Challenge, error) {
...
// MissionRepository_ListMultiModeMissions_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'ListMultiChallenges'
...
func (_e *MissionRepository_Expecter) ListMultiModeMissions(ctx interface{}, params interface{}) *MissionRepository_ListMultiModeMissions_Call {
	return &MissionRepository_ListMultiModeMissions_Call{Call: _e.mock.On("ListMultiChallenges", ctx, params)}
}

func (_c *MissionRepository_ListMultiModeMissions_Call) Run(run func(ctx context.Context, params entity.ListMultiChallengeParams)) *MissionRepository_ListMultiModeMissions_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MissionRepository_ListMultiModeMissions_Call) RunAndReturn(run func(context.Context, entity.ListMultiChallengeParams) ([]entity.Challenge, error)) *MissionRepository_ListMultiModeMissions_Call {
	_c.Call.Return(run)
	return _c
}
